...
def _init_pg_schema_on_conn(conn):
    ...
    queries = [
        ...
        "CREATE TABLE IF NOT EXISTS attendance_events (id TEXT PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), person_id INTEGER NOT NULL REFERENCES faces(id), legacy_attendance_id INTEGER REFERENCES attendance(id), event_type TEXT NOT NULL, event_time_utc TIMESTAMP NOT NULL, event_timezone TEXT NOT NULL, received_at_utc TIMESTAMP NOT NULL, source TEXT NOT NULL, source_event_id TEXT NOT NULL, device_id TEXT, location_id INTEGER, activity_code TEXT, verification_method TEXT, verification_score REAL, captured_image_reference TEXT, payload_metadata TEXT DEFAULT '{}', ingestion_status TEXT NOT NULL DEFAULT 'ACCEPTED', created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, source, source_event_id))",
        "CREATE TABLE IF NOT EXISTS locations (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), code TEXT NOT NULL, name TEXT NOT NULL, location_type TEXT NOT NULL DEFAULT 'OFFICE', timezone TEXT NOT NULL DEFAULT 'Asia/Kolkata', address TEXT, geofence_lat REAL, geofence_lng REAL, geofence_radius_m REAL, is_active INTEGER NOT NULL DEFAULT 1, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, code))",
        "CREATE TABLE IF NOT EXISTS organization_units (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), parent_id INTEGER REFERENCES organization_units(id), location_id INTEGER REFERENCES locations(id), code TEXT NOT NULL, name TEXT NOT NULL, unit_type TEXT NOT NULL, is_active INTEGER NOT NULL DEFAULT 1, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, code))",
        "CREATE TABLE IF NOT EXISTS person_organization_assignments (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), person_id INTEGER NOT NULL REFERENCES faces(id), organization_unit_id INTEGER NOT NULL REFERENCES organization_units(id), effective_from DATE NOT NULL, effective_to DATE, is_primary INTEGER NOT NULL DEFAULT 1, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)",
        "CREATE TABLE IF NOT EXISTS shifts (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), code TEXT NOT NULL, name TEXT NOT NULL, is_active INTEGER NOT NULL DEFAULT 1, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, code))",
        "CREATE TABLE IF NOT EXISTS shift_versions (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), shift_id INTEGER NOT NULL REFERENCES shifts(id), version_number INTEGER NOT NULL, effective_from DATE NOT NULL, effective_to DATE, start_time TEXT NOT NULL, end_time TEXT NOT NULL, timezone TEXT NOT NULL DEFAULT 'Asia/Kolkata', operational_day_offset INTEGER NOT NULL DEFAULT 0, grace_minutes INTEGER NOT NULL DEFAULT 0, is_cross_midnight INTEGER NOT NULL DEFAULT 0, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(shift_id, version_number))",
        "CREATE TABLE IF NOT EXISTS shift_segments (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), shift_version_id INTEGER NOT NULL REFERENCES shift_versions(id), segment_type TEXT NOT NULL, start_time TEXT NOT NULL, end_time TEXT NOT NULL, is_paid INTEGER NOT NULL DEFAULT 1, sequence INTEGER NOT NULL DEFAULT 0)",
        "CREATE TABLE IF NOT EXISTS shift_assignments (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), shift_id INTEGER NOT NULL REFERENCES shifts(id), scope_type TEXT NOT NULL, person_id INTEGER REFERENCES faces(id), organization_unit_id INTEGER REFERENCES organization_units(id), location_id INTEGER REFERENCES locations(id), group_key TEXT, effective_from DATE NOT NULL, effective_to DATE, priority INTEGER NOT NULL DEFAULT 0, assignment_source TEXT NOT NULL DEFAULT 'MANUAL', created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)",
        "CREATE TABLE IF NOT EXISTS holiday_calendars (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), location_id INTEGER REFERENCES locations(id), name TEXT NOT NULL, timezone TEXT NOT NULL DEFAULT 'Asia/Kolkata', is_active INTEGER NOT NULL DEFAULT 1)",
        "CREATE TABLE IF NOT EXISTS holidays (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), calendar_id INTEGER NOT NULL REFERENCES holiday_calendars(id), holiday_date DATE NOT NULL, name TEXT NOT NULL, is_paid INTEGER NOT NULL DEFAULT 1, UNIQUE(calendar_id, holiday_date))",
        "CREATE TABLE IF NOT EXISTS weekly_off_patterns (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), name TEXT NOT NULL, weekdays TEXT NOT NULL DEFAULT '[]', effective_from DATE NOT NULL, effective_to DATE, location_id INTEGER REFERENCES locations(id), organization_unit_id INTEGER REFERENCES organization_units(id))",
        ...
        "CREATE TABLE IF NOT EXISTS app_update_device_status (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), device_id TEXT NOT NULL, release_id INTEGER, target_version_code INTEGER NOT NULL, installed_version_code INTEGER, installed_version_name TEXT, status TEXT NOT NULL, progress INTEGER, error_code TEXT, error_message TEXT, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, device_id, target_version_code))",
        ...
        "CREATE TABLE IF NOT EXISTS report_delivery_jobs (id TEXT PRIMARY KEY, vendor_id INTEGER REFERENCES vendors(id) NOT NULL, report_kind TEXT NOT NULL, reference_id TEXT, person_id INTEGER, idempotency_key TEXT NOT NULL UNIQUE, recipient_email TEXT NOT NULL, artifact_key TEXT, status TEXT NOT NULL DEFAULT 'queued', attempts INTEGER NOT NULL DEFAULT 0, message_id TEXT, error TEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, prepared_at TIMESTAMP, sent_at TIMESTAMP)",
        ...
        "CREATE TABLE IF NOT EXISTS hostel_buildings (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), name TEXT NOT NULL, code TEXT, sort_order INTEGER NOT NULL DEFAULT 0, eligibility_rules TEXT NOT NULL DEFAULT '{}', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, name))",
        "CREATE TABLE IF NOT EXISTS hostel_floors (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), building_id INTEGER NOT NULL REFERENCES hostel_buildings(id) ON DELETE CASCADE, name TEXT NOT NULL, sort_order INTEGER NOT NULL DEFAULT 0, eligibility_rules TEXT NOT NULL DEFAULT '{}', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, UNIQUE(building_id, name))",
        "CREATE TABLE IF NOT EXISTS hostel_rooms (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), floor_id INTEGER NOT NULL REFERENCES hostel_floors(id) ON DELETE CASCADE, room_number TEXT NOT NULL, room_type TEXT NOT NULL DEFAULT 'Standard', position_index INTEGER NOT NULL DEFAULT 0, eligibility_rules TEXT NOT NULL DEFAULT '{}', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, UNIQUE(floor_id, room_number))",
        "CREATE TABLE IF NOT EXISTS hostel_beds (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), room_id INTEGER NOT NULL REFERENCES hostel_rooms(id) ON DELETE CASCADE, bed_label TEXT NOT NULL, position_index INTEGER NOT NULL DEFAULT 0, availability_status TEXT NOT NULL DEFAULT 'available', unavailable_reason TEXT, unavailable_note TEXT, unavailable_from DATE, expected_reopening_date DATE, reservation_expires_at TIMESTAMP, reserved_for_person_id INTEGER REFERENCES faces(id), reservation_note TEXT, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, UNIQUE(room_id, bed_label))",
        "CREATE TABLE IF NOT EXISTS hostel_allocations (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), person_id INTEGER NOT NULL REFERENCES faces(id), bed_id INTEGER NOT NULL REFERENCES hostel_beds(id), allocated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, allocated_by TEXT, UNIQUE(vendor_id, person_id), UNIQUE(bed_id))",
        "CREATE TABLE IF NOT EXISTS hostel_allocation_history (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), person_id INTEGER NOT NULL, action TEXT NOT NULL, previous_bed_id INTEGER, new_bed_id INTEGER, actor_username TEXT, reason TEXT, override_reason TEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)",
        "CREATE TABLE IF NOT EXISTS hostel_staff_permissions (id SERIAL PRIMARY KEY, vendor_id INTEGER NOT NULL REFERENCES vendors(id), username TEXT NOT NULL, building_id INTEGER REFERENCES hostel_buildings(id) ON DELETE CASCADE, access_role TEXT NOT NULL DEFAULT 'viewer', can_export INTEGER NOT NULL DEFAULT 0, can_override_eligibility INTEGER NOT NULL DEFAULT 0, can_view_resident_details INTEGER NOT NULL DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, username, building_id))",
        ...
        "CREATE INDEX IF NOT EXISTS idx_attendance_events_person_time ON attendance_events(vendor_id, person_id, event_time_utc)",
        "CREATE INDEX IF NOT EXISTS idx_attendance_events_device_received ON attendance_events(vendor_id, device_id, received_at_utc)",
        "CREATE INDEX IF NOT EXISTS idx_shift_assignment_resolution ON shift_assignments(vendor_id, person_id, effective_from, effective_to)",
        "CREATE INDEX IF NOT EXISTS idx_shift_version_resolution ON shift_versions(vendor_id, shift_id, effective_from, effective_to)",
        "CREATE INDEX IF NOT EXISTS idx_person_org_resolution ON person_organization_assignments(vendor_id, person_id, effective_from, effective_to)",
        ...
        "CREATE INDEX IF NOT EXISTS idx_app_update_status_target ON app_update_device_status(target_version_code, status)",
        ...
        ,"CREATE INDEX IF NOT EXISTS idx_report_delivery_vendor ON report_delivery_jobs(vendor_id, created_at)"
        ,"CREATE INDEX IF NOT EXISTS idx_report_delivery_reference ON report_delivery_jobs(vendor_id, reference_id)"
...
def init_sqlite_schema(conn):
    ...
    queries = [
        ...
        "CREATE TABLE IF NOT EXISTS attendance_events (id TEXT PRIMARY KEY, vendor_id INTEGER NOT NULL, person_id INTEGER NOT NULL, legacy_attendance_id INTEGER, event_type TEXT NOT NULL, event_time_utc DATETIME NOT NULL, event_timezone TEXT NOT NULL, received_at_utc DATETIME NOT NULL, source TEXT NOT NULL, source_event_id TEXT NOT NULL, device_id TEXT, location_id INTEGER, activity_code TEXT, verification_method TEXT, verification_score REAL, captured_image_reference TEXT, payload_metadata TEXT DEFAULT '{}', ingestion_status TEXT NOT NULL DEFAULT 'ACCEPTED', created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, source, source_event_id))",
        "CREATE TABLE IF NOT EXISTS locations (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, code TEXT NOT NULL, name TEXT NOT NULL, location_type TEXT NOT NULL DEFAULT 'OFFICE', timezone TEXT NOT NULL DEFAULT 'Asia/Kolkata', address TEXT, geofence_lat REAL, geofence_lng REAL, geofence_radius_m REAL, is_active INTEGER NOT NULL DEFAULT 1, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, code))",
        "CREATE TABLE IF NOT EXISTS organization_units (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, parent_id INTEGER, location_id INTEGER, code TEXT NOT NULL, name TEXT NOT NULL, unit_type TEXT NOT NULL, is_active INTEGER NOT NULL DEFAULT 1, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, code))",
        "CREATE TABLE IF NOT EXISTS person_organization_assignments (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, person_id INTEGER NOT NULL, organization_unit_id INTEGER NOT NULL, effective_from DATE NOT NULL, effective_to DATE, is_primary INTEGER NOT NULL DEFAULT 1, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)",
        "CREATE TABLE IF NOT EXISTS shifts (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, code TEXT NOT NULL, name TEXT NOT NULL, is_active INTEGER NOT NULL DEFAULT 1, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, code))",
        "CREATE TABLE IF NOT EXISTS shift_versions (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, shift_id INTEGER NOT NULL, version_number INTEGER NOT NULL, effective_from DATE NOT NULL, effective_to DATE, start_time TEXT NOT NULL, end_time TEXT NOT NULL, timezone TEXT NOT NULL DEFAULT 'Asia/Kolkata', operational_day_offset INTEGER NOT NULL DEFAULT 0, grace_minutes INTEGER NOT NULL DEFAULT 0, is_cross_midnight INTEGER NOT NULL DEFAULT 0, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(shift_id, version_number))",
        "CREATE TABLE IF NOT EXISTS shift_segments (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, shift_version_id INTEGER NOT NULL, segment_type TEXT NOT NULL, start_time TEXT NOT NULL, end_time TEXT NOT NULL, is_paid INTEGER NOT NULL DEFAULT 1, sequence INTEGER NOT NULL DEFAULT 0)",
        "CREATE TABLE IF NOT EXISTS shift_assignments (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, shift_id INTEGER NOT NULL, scope_type TEXT NOT NULL, person_id INTEGER, organization_unit_id INTEGER, location_id INTEGER, group_key TEXT, effective_from DATE NOT NULL, effective_to DATE, priority INTEGER NOT NULL DEFAULT 0, assignment_source TEXT NOT NULL DEFAULT 'MANUAL', created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)",
        "CREATE TABLE IF NOT EXISTS holiday_calendars (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, location_id INTEGER, name TEXT NOT NULL, timezone TEXT NOT NULL DEFAULT 'Asia/Kolkata', is_active INTEGER NOT NULL DEFAULT 1)",
        "CREATE TABLE IF NOT EXISTS holidays (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, calendar_id INTEGER NOT NULL, holiday_date DATE NOT NULL, name TEXT NOT NULL, is_paid INTEGER NOT NULL DEFAULT 1, UNIQUE(calendar_id, holiday_date))",
        "CREATE TABLE IF NOT EXISTS weekly_off_patterns (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, name TEXT NOT NULL, weekdays TEXT NOT NULL DEFAULT '[]', effective_from DATE NOT NULL, effective_to DATE, location_id INTEGER, organization_unit_id INTEGER)",
        ...
        "CREATE TABLE IF NOT EXISTS app_update_device_status (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, device_id TEXT NOT NULL, release_id INTEGER, target_version_code INTEGER NOT NULL, installed_version_code INTEGER, installed_version_name TEXT, status TEXT NOT NULL, progress INTEGER, error_code TEXT, error_message TEXT, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, device_id, target_version_code))",
        ...
        "CREATE TABLE IF NOT EXISTS report_delivery_jobs (id TEXT PRIMARY KEY, vendor_id INTEGER NOT NULL, report_kind TEXT NOT NULL, reference_id TEXT, person_id INTEGER, idempotency_key TEXT NOT NULL UNIQUE, recipient_email TEXT NOT NULL, artifact_key TEXT, status TEXT NOT NULL DEFAULT 'queued', attempts INTEGER NOT NULL DEFAULT 0, message_id TEXT, error TEXT, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, prepared_at DATETIME, sent_at DATETIME)",
        ...
        "CREATE TABLE IF NOT EXISTS hostel_buildings (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, name TEXT NOT NULL, code TEXT, sort_order INTEGER NOT NULL DEFAULT 0, eligibility_rules TEXT NOT NULL DEFAULT '{}', created_at DATETIME DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, name))",
        "CREATE TABLE IF NOT EXISTS hostel_floors (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, building_id INTEGER NOT NULL, name TEXT NOT NULL, sort_order INTEGER NOT NULL DEFAULT 0, eligibility_rules TEXT NOT NULL DEFAULT '{}', created_at DATETIME DEFAULT CURRENT_TIMESTAMP, UNIQUE(building_id, name))",
        "CREATE TABLE IF NOT EXISTS hostel_rooms (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, floor_id INTEGER NOT NULL, room_number TEXT NOT NULL, room_type TEXT NOT NULL DEFAULT 'Standard', position_index INTEGER NOT NULL DEFAULT 0, eligibility_rules TEXT NOT NULL DEFAULT '{}', created_at DATETIME DEFAULT CURRENT_TIMESTAMP, UNIQUE(floor_id, room_number))",
        "CREATE TABLE IF NOT EXISTS hostel_beds (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, room_id INTEGER NOT NULL, bed_label TEXT NOT NULL, position_index INTEGER NOT NULL DEFAULT 0, availability_status TEXT NOT NULL DEFAULT 'available', unavailable_reason TEXT, unavailable_note TEXT, unavailable_from DATE, expected_reopening_date DATE, reservation_expires_at DATETIME, reserved_for_person_id INTEGER, reservation_note TEXT, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP, UNIQUE(room_id, bed_label))",
        "CREATE TABLE IF NOT EXISTS hostel_allocations (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, person_id INTEGER NOT NULL, bed_id INTEGER NOT NULL, allocated_at DATETIME DEFAULT CURRENT_TIMESTAMP, allocated_by TEXT, UNIQUE(vendor_id, person_id), UNIQUE(bed_id))",
        "CREATE TABLE IF NOT EXISTS hostel_allocation_history (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, person_id INTEGER NOT NULL, action TEXT NOT NULL, previous_bed_id INTEGER, new_bed_id INTEGER, actor_username TEXT, reason TEXT, override_reason TEXT, created_at DATETIME DEFAULT CURRENT_TIMESTAMP)",
        "CREATE TABLE IF NOT EXISTS hostel_staff_permissions (id INTEGER PRIMARY KEY AUTOINCREMENT, vendor_id INTEGER NOT NULL, username TEXT NOT NULL, building_id INTEGER, access_role TEXT NOT NULL DEFAULT 'viewer', can_export INTEGER NOT NULL DEFAULT 0, can_override_eligibility INTEGER NOT NULL DEFAULT 0, can_view_resident_details INTEGER NOT NULL DEFAULT 0, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP, UNIQUE(vendor_id, username, building_id))",
