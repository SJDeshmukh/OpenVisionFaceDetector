...
def run_safe_migration():
    ...
    tables = [
        ...
        ('faces', 
         ...
         None, 'id'),
        ('hostel_buildings', ['id', 'vendor_id', 'name', 'code', 'sort_order', 'eligibility_rules', 'created_at'], None, 'id'),
        ('hostel_floors', ['id', 'vendor_id', 'building_id', 'name', 'sort_order', 'eligibility_rules', 'created_at'], None, 'id'),
        ('hostel_rooms', ['id', 'vendor_id', 'floor_id', 'room_number', 'room_type', 'position_index', 'eligibility_rules', 'created_at'], None, 'id'),
        ('hostel_beds', ['id', 'vendor_id', 'room_id', 'bed_label', 'position_index', 'availability_status', 'unavailable_reason', 'unavailable_note', 'unavailable_from', 'expected_reopening_date', 'reservation_expires_at', 'reserved_for_person_id', 'reservation_note', 'updated_at'], None, 'id'),
        ('hostel_allocations', ['id', 'vendor_id', 'person_id', 'bed_id', 'allocated_at', 'allocated_by'], None, 'id'),
        ('hostel_allocation_history', ['id', 'vendor_id', 'person_id', 'action', 'previous_bed_id', 'new_bed_id', 'actor_username', 'reason', 'override_reason', 'created_at'], None, 'id'),
        ('hostel_staff_permissions', ['id', 'vendor_id', 'username', 'building_id', 'access_role', 'can_export', 'can_override_eligibility', 'can_view_resident_details', 'created_at', 'updated_at'], None, 'id'),
        ('attendance', 
