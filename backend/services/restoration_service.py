...
def run_restore(sqlite_backup_path):
    ...
    tables = [
        ...
        ('hostel_buildings', ['id', 'vendor_id', 'name', 'code', 'sort_order', 'eligibility_rules', 'created_at']),
        ('hostel_floors', ['id', 'vendor_id', 'building_id', 'name', 'sort_order', 'eligibility_rules', 'created_at']),
        ('hostel_rooms', ['id', 'vendor_id', 'floor_id', 'room_number', 'room_type', 'position_index', 'eligibility_rules', 'created_at']),
        ('hostel_beds', ['id', 'vendor_id', 'room_id', 'bed_label', 'position_index', 'availability_status', 'unavailable_reason', 'unavailable_note', 'unavailable_from', 'expected_reopening_date', 'reservation_expires_at', 'reserved_for_person_id', 'reservation_note', 'updated_at']),
        ('hostel_allocations', ['id', 'vendor_id', 'person_id', 'bed_id', 'allocated_at', 'allocated_by']),
        ('hostel_allocation_history', ['id', 'vendor_id', 'person_id', 'action', 'previous_bed_id', 'new_bed_id', 'actor_username', 'reason', 'override_reason', 'created_at']),
        ('hostel_staff_permissions', ['id', 'vendor_id', 'username', 'building_id', 'access_role', 'can_export', 'can_override_eligibility', 'can_view_resident_details', 'created_at', 'updated_at']),
        ...
        ('parent_users', ['id', 'vendor_id', 'username', 'password', 'contact_email', 'contact_phone', 'student_number', 'selected_person_id', 'device_id', 'fcm_token', 'session_version', 'face_image', 'face_template', 'face_server_template', 'created_at']),
        ('student_parents', ['id', 'vendor_id', 'person_id', 'parent_id', 'created_at']),
        ('parent_tokens', ['token', 'vendor_id', 'student_number', 'created_at'], 'token'),
        ('leave_requests', ['id', 'vendor_id', 'student_id', 'leave_type', 'reason', 'start_date', 'end_date', 'start_time', 'end_time', 'parent_status', 'rector_status', 'hod_status', 'final_status', 'created_at']),
        ('leave_staff', ['id', 'vendor_id', 'name', 'role', 'pin', 'department', 'created_at']),
        ('leave_workflows', ['id', 'vendor_id', 'name', 'version', 'is_active', 'created_by', 'created_at']),
        ('leave_workflow_stages', ['id', 'workflow_id', 'stage_key', 'display_name', 'actor_type', 'role_key', 'sequence', 'department_scoped', 'auth_method']),
        ('leave_request_stages', ['id', 'request_id', 'vendor_id', 'workflow_id', 'workflow_version', 'stage_key', 'display_name', 'actor_type', 'role_key', 'sequence', 'department_scoped', 'auth_method', 'status', 'actor_id', 'actor_name', 'decided_at', 'decision_metadata', 'created_at']),
