...
const LiveFeed = () => {
    ...
    // WebRTC signaling is handled within each DeviceMonitor component
                        ...
                        {loading ? (
                            ...
                            activeVendorsList.map(vendor => (
                                <button
                                    ...
                                    className={`w-full text-left p-3 rounded-xl flex items-center justify-between transition-all ${selectedVendorId === vendor.id
